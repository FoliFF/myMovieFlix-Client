...
export class MovieView extends React.Component {
    ...
    getUser(token) {
        ...
        axios
            .get(`https://movie-api-21197.herokuapp.com/users/${user}`, {
    ...
    addFavMovie = () => {
        ...
        if (!isFav) {
            axios.post(`https://movie-api-21197.herokuapp.com/users/${user}/movies/${this.props.movie._id}`, {},
                {
                    headers: {
    ...
    removeFavMovie = () => {
        let token = localStorage.getItem('token');
        let user = localStorage.getItem("user");
        axios.delete(`https://movie-api-21197.herokuapp.com/users/${user}/movies/${this.props.movie._id}`,
            {
                headers: { Authorization: `Bearer ${token}` },
            }).then((response) => {
                console.log(response.data);
